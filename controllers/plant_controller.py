...
from models import Plantation,Section
...
@login_required
def client_index():
    sections_per_plantation = Section.get_plants(current_user.id)  #esse id está manual, tem q ser alterado para ser com base no usuario logado
